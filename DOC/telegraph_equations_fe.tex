...
This document explains the telegraph equations simulation using finite element method based on MFEM library. It is a fail tentative; I never succeed getting the system to converge.
